...
<div id="customerEventModal" class="modal">
  <div class="modal-content">
    ...
    <div class="scrollable">
      <form id="customerEventForm" method="POST" action="../php/customer-add-event.php" class="form-container">
        ...
        <!-- Hidden field → always Pending Approval -->
        <input type="hidden" name="event_status" value="Pending Approval">
